...
public class FfmpegRenderersFactory implements RenderersFactory {
    ...
    private @FfmpegRenderersFactory.ExtensionRendererMode int extensionRendererMode;
    ...
    public FfmpegRenderersFactory setExtensionRendererMode(
            @FfmpegRenderersFactory.ExtensionRendererMode int extensionRendererMode) {
     ...
     */
    @CanIgnoreReturnValue
    public FfmpegRenderersFactory forceEnableMediaCodecAsynchronousQueueing() {
     ...
     */
    @CanIgnoreReturnValue
    public FfmpegRenderersFactory forceDisableMediaCodecAsynchronousQueueing() {
    ...
    protected void buildCameraMotionRenderers(
            Context context, @FfmpegRenderersFactory.ExtensionRendererMode int extensionRendererMode, ArrayList<Renderer> out) {
